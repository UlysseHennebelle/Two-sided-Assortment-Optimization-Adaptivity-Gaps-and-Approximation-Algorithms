from tsao.benchmarks.dynamic_programs import optimize_fully_adaptive, optimize_one_sided_adaptive
from tsao.benchmarks.opt_fully_static import enumerate_fully_static, optimize_fully_static
from tsao.benchmarks.opt_one_sided_static import optimize_one_sided_static
...
def test_optimized_dynamic_programs_match_legacy_reference_values() -> None:
    instance = _instance()
